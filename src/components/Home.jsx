      ...
      <Card className={classes.description} variant="elevation">
        <div className={classes.descText}>
          <div style={{ textAlign: "left", padding: "10px 0 10px 10px" }}>
            <p>
              Bienvenida a la configuración de Remotely. Al hacer clic en
              'Iniciar', se le llevará a través de la configuración del sitio
              paso a paso.
            </p>

            <p className={classes.steps}>
              <b>Paso 1</b> le pedirá información general sobre su sitio.
              Preparese para poner el nombre, la descripción, y la lema del
              sitio. Tambien prepare las imagenes que seran el logo primario, el
              icono de menu hamburguesa, y el favicon.
            </p>

            <p className={classes.steps}>
              <b>Paso 2</b> le pedirá que proporcione una paleta de colores para
              el sitio. Al mínimo prepárese para seleccionar un color primario,
              color secundario, color de fondo, y color de superficie.
            </p>

            <p className={classes.steps}>
              <b>Paso 3</b> le pedirá las redes sociales. Aceptará información
              de Facebook, Twitter, Instagram, YouTube, y sitio de web. Además,
              la información de contacto de su institución, como el email
            ...
            <p>
              ...
              Configuraciones avanzadas también están disponibles, aunque son
              opcionales.
            </p>
          </div>
          <img
