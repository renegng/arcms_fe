...
import { StepOne, StepThree, StepTwo, StepFour, StepFive } from "./SetupSteps";
...
const Setup = ({ classes, orgData, searchOrgs, addOrg }) => {
  ...
  return (
    <div className={classes.root}>
        ...
        <Toolbar>
          <div>
            ...
            <Menu open={menuOpen} anchorEl={anchorEl} onClose={handleMenuClose}>
              ...
              <MenuItem>Configuraciones Avanzadas</MenuItem>
            </Menu>
          </div>
          Remotely
        </Toolbar>
      ...
      <main>
        <h1 style={{ color: "#392F5A" }}>
          Configuración del sitio web de Remotely
        </h1>
      </main>
      ...
      <TabContext value={value}>
        <Tabs
          centered={true}
          value={value}
          TabIndicatorProps={{ style: { background: "#392F5A" } }}
        ...
        <TabPanel value="4">
          <StepFour handleTabChange={handleTabChange} nextValue={"5"} />
        </TabPanel>
        <TabPanel value="5">
          <StepFive handleTabChange={handleTabChange} nextValue={"5"} />
        </TabPanel>
      </TabContext>
